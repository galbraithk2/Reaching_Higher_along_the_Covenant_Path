...
export const booths: Record<CategoryKey, Booth[]> = {
  ...
  missionary: [
    ...
    },
    {
      ...
      desc: '<div class="modal-image-row"><img src="/Reaching_Higher_along_the_Covenant_Path/images/bagsoflove.gif" alt="Bags of Love comfort kit items" class="modal-feature-img" /><p><strong>\u201CBags of Love\u201D Service Project</strong> \u2014 \u201CBags of Love\u201D is created to give comfort to a child or children that may need help if a parent is in an accident and needs to go to the hospital, or a parent may be arrested and taken to jail, or families have become homeless and the child needs something to not feel so alone. A youth may be a runaway and/or contemplating suicide\u200A\u2014\u200Athe Bag of Love would be something encouraging to let them know someone cares.</p></div><p style="margin-top:14px"><strong>Assemble a Bag at the Booth</strong> \u2014 Grab a bag and fill it with comfort items for a younger or older child:</p><ul style="margin:8px 0 0 18px;line-height:1.7"><li>Soft lap blanket &amp; stuffed animal</li><li>Coloring book &amp; colored pencils (younger) or puzzle book &amp; reading book (older)</li><li>Hairbrush, small shampoo, toothbrush &amp; toothpaste</li><li>Chapstick &amp; individually wrapped snacks</li></ul><p style="margin-top:10px">Everything fits in a single 2\u2011gallon Ziploc bag. Feel free to make bags for boys or girls\u200A\u2014\u200Ajust label them. Not all bags need to be the same\u200A\u2014\u200Ause your heart.</p><p style="margin-top:14px"><strong>Find More Ways to Serve</strong> \u2014 Browse local volunteer opportunities at <a href="https://www.justserve.org" target="_blank" rel="noopener noreferrer">JustServe.org</a> and sign up on the spot.</p><p style="margin-top:14px"><em>A small bag can carry a lot of love.</em></p>',
    },
  ],
  rising: [
    {
