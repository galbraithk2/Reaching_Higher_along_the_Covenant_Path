...
const jobSearchData = {
  ...
  who: "John Ekins & Elder Gary Chapman (Employment Missionary)",
...
export const booths: Record<CategoryKey, Booth[]> = {
  ...
  rising: [
    ...
    },
    {
      ...
      desc: "Build faith. Find friends. Live the gospel. Learn what Institute offers young adults, why it matters, and how to join. Institute classes are available for all young adults ages 18–35.<br><br>Click here to find an Institute class near you: <a href=\"https://myinstitute.churchofjesuschrist.org/\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:#1a73e8;\">https://myinstitute.churchofjesuschrist.org/</a>",
    },
  ],
  selfreliance: [
    {
...
export const classes: ClassItem[] = [
  ...
  },
  {
    ...
    desc: 'Discover meaningful ways to teach the gospel within your home. Share ideas and learn from others about creating a home centered on Christ.<div class="download-icons-row"><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/Stake Event Families-3-2026.pdf" download="Stake Event Families-3-2026.pdf" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/spiritual-survival-pdf.png" alt="Download PDF" class="download-icon-img" /><span class="download-icon-label">Download PDF</span></a><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/Stake Event, Families-3-2026.docx" download="Stake Event, Families-3-2026.docx" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/spiritual-survival-doc.png" alt="Download Word Document" class="download-icon-img" /><span class="download-icon-label">Download Word Doc</span></a></div>',
  },
  {
  ...
  },
  {
    ...
    desc: 'Learn practical strategies to organize your family\'s vital documents. Get tips on what to keep, how to store it, and how to be prepared for the unexpected.<hr class="download-section-divider" /><h4 class="download-section-title">Family Information Book</h4><div class="download-icons-row"><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/FAMILY INFORMATION BOOK.pdf" download="FAMILY INFORMATION BOOK.pdf" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/vital-documents-pdf.png" alt="Download PDF" class="download-icon-img" /><span class="download-icon-label">Download PDF</span></a><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/FAMILY INFORMATION BOOK.docx" download="FAMILY INFORMATION BOOK.docx" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/vital-documents-doc.png" alt="Download Word Document" class="download-icon-img" /><span class="download-icon-label">Download Word Doc</span></a></div><hr class="download-section-divider" /><h4 class="download-section-title">Funeral Preparation</h4><div class="download-icons-row"><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/And%20Should%20We%20Die.pdf" download="And Should We Die.pdf" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/funeral-prep-pdf.svg" alt="Download PDF" class="download-icon-img" /><span class="download-icon-label">Download PDF</span></a><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/And%20Should%20We%20Die.docx" download="And Should We Die.docx" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/funeral-prep-doc.svg" alt="Download Word Document" class="download-icon-img" /><span class="download-icon-label">Download Word Doc</span></a></div>',
  },
  {
    title: "Family History Q&A",
