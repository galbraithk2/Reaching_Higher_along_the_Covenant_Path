...
export const classes: ClassItem[] = [
  ...
  },
  {
    ...
    desc: 'Learn practical strategies to organize your family\'s vital documents. Get tips on what to keep, how to store it, and how to be prepared for the unexpected.<hr class="download-section-divider" /><h4 class="download-section-title">Family Information Book</h4><div class="download-icons-row"><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/FAMILY INFORMATION BOOK.pdf" download="FAMILY INFORMATION BOOK.pdf" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/vital-documents-pdf.png" alt="Download PDF" class="download-icon-img" /><span class="download-icon-label">Download PDF</span></a><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/FAMILY INFORMATION BOOK.docx" download="FAMILY INFORMATION BOOK.docx" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/vital-documents-doc.png" alt="Download Word Document" class="download-icon-img" /><span class="download-icon-label">Download Word Doc</span></a></div><hr class="download-section-divider" /><h4 class="download-section-title">Funeral Preparation</h4><div class="download-icons-row"><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/And%20Should%20We%20Die.pdf" download="And Should We Die.pdf" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/and-should-we-die-pdf.svg" alt="Download PDF" class="download-icon-img" /><span class="download-icon-label">Download PDF</span></a><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/And%20Should%20We%20Die.docx" download="And Should We Die.docx" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/and-should-we-die-doc.svg" alt="Download Word Document" class="download-icon-img" /><span class="download-icon-label">Download Word Doc</span></a></div>',
  },
  {
    title: "Family History Q&A",
