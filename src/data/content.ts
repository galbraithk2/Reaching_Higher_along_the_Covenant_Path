...
const jobSearchData = {
  ...
  who: "John Ekins & Elder Chapman (Employment Missionary)",
...
export const classes: ClassItem[] = [
  ...
  },
  {
    ...
    desc: 'Learn practical strategies to organize your family\'s vital documents. Get tips on what to keep, how to store it, and how to be prepared for the unexpected.<div class="download-icons-row"><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/FAMILY INFORMATION BOOK.pdf" download="FAMILY INFORMATION BOOK.pdf" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/vital-documents-pdf.png" alt="Download PDF" class="download-icon-img" /><span class="download-icon-label">Download PDF</span></a><a href="/Reaching_Higher_along_the_Covenant_Path/pdfs/FAMILY INFORMATION BOOK.docx" download="FAMILY INFORMATION BOOK.docx" class="download-icon-link"><img src="/Reaching_Higher_along_the_Covenant_Path/images/vital-documents-doc.png" alt="Download Word Document" class="download-icon-img" /><span class="download-icon-label">Download Word Doc</span></a></div>',
  },
  {
    title: "Family History Q&A",
