...
export default function HallLayout() {
  ...
  return (
    <div className="hall-page">
      ...
      <p className="hall-footer-note">
        Whether you&rsquo;re chasing toddlers, starting a career, raising teenagers, enjoying retirement, or somewhere in between &mdash;{" "}
        <span
